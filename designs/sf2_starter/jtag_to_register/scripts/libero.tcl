...
create_links                        \
	...
	-hdl_source $src/sf2_starter.sv \
	-hdl_source $ip/jtag_to_register/src/jtag_to_register.sv

# Constraints
create_links                         \
	-convert_EDN_to_HDL 0            \
	-io_pdc $scripts/sf2_starter.pdc \
	-sdc $scripts/sf2_starter.sdc

# Set the design root
build_design_hierarchy
set_root -module {sf2_starter::work}

# Enable SDC for synthesis
organize_tool_files -tool {SYNTHESIZE} \
	-file $scripts/sf2_starter.sdc     \
	-module {sf2_starter::work}        \
	-input_type {constraint}

# Enable PDC and SDC for place-and-route
organize_tool_files -tool {PLACEROUTE} \
	-file $scripts/sf2_starter.sdc     \
	-file $scripts/sf2_starter.pdc     \
	-module {sf2_starter::work}        \
	-input_type {constraint}
