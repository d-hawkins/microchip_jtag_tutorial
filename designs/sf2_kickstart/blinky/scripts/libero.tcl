...
create_links                          \
	...
	-hdl_source $src/sf2_kickstart.sv

# Constraints
create_links                           \
	-convert_EDN_to_HDL 0              \
	-io_pdc $scripts/sf2_kickstart.pdc \
	-sdc $scripts/sf2_kickstart.sdc

# Set the design root
build_design_hierarchy
set_root -module {sf2_kickstart::work}

# Enable SDC for synthesis
organize_tool_files -tool {SYNTHESIZE} \
	-file $scripts/sf2_kickstart.sdc   \
	-module {sf2_kickstart::work}      \
	-input_type {constraint}

# Enable PDC and SDC for place-and-route
organize_tool_files -tool {PLACEROUTE} \
	-file $scripts/sf2_kickstart.sdc   \
	-file $scripts/sf2_kickstart.pdc   \
	-module {sf2_kickstart::work}      \
	-input_type {constraint}
